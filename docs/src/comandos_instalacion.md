...
Comandos utilizados para instalar.
...
Comandos para instalar las piezas vitales de PHP que Linux Mint no trae por defecto, necesarias para que Laravel funcione correctamente.
...
# 3. Cambiar la contraseña del usuario principal por seguridad (Ejemplo: '1234')
